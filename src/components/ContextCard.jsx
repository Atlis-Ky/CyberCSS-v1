  ...
  return (
    <section className="text-center mb-3" style={{ padding: "2rem 0" }}>
      <div className="container">
        ...
        <p>
          That's easy! Just head to the repo and either download the cyber.css
          file into your project, or paste the file into your own code, super
          ...
          through the sections, and using the shortcut <code>⌘ + F</code> on
          MacOS, or <code>CTRL + F</code> on windows to find any specific
          classes you're looking to target.
        </p>
        ...
        <div style={{ marginTop: "1.5rem" }}>
          <button
            ...
            onClick={() =>
              window.open(
                "https://github.com/Atlis-Ky/CyberCSS-v1",
                "_blank",
                "noopener,noreferrer"
              )
            }
